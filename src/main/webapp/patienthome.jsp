...
<header>
    ...
    <nav class="navbar">
        <a href="#home">Home</a>
        <a href="addappointment.jsp">Appoinment</a>
    ...
    <div class="box-container">
        ...
        <div class="box">
            ...
            <div class="content">
                ...
                <p> An endocrinologist is a healthcare provider who's an expert in endocrinology — the study of your body's hormones.</p>
                <a href="#" class="btn">book now</a>
            </div>
        </div>
        ...
        <div class="box">
            ...
            <div class="content">
                <h3>Cosmetologist </h3>
                <p>A cosmetologist is an expert in applying cosmetic procedures, therapies, and treatments to beautify one’s outer appearance, and implementing cosmetic treatments to people’s hair, skin, and nails. </p>
                <a href="#" class="btn">book now</a>
            </div>
        </div>
