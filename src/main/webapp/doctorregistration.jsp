...
<body>
 ...
 <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <section class="vh-100 gradient-custom">
        <div  class="form" ,  class="container py-5 h-100">
          <div class="row justify-content-center align-items-center h-100">
            <div class="col-12 col-lg-9 col-xl-7">
              <div class="card shadow-2-strong card-registration" style="border-radius: 15px;">
                <div class="card-body p-4 p-md-5">
                  <h3 class="mb-4 pb-2 pb-md-0 mb-md-5">Add Doctor</h3>
                  
                  <form action="adddoctor" method="POST" modelAttribute="doc">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6 mb-4 pb-2">
                        ...
                        <div class="form-outline">
                          <input type="number" id="phoneNumber" class="form-control form-control-lg"  name="experience" />
                          <label class="form-label" for="phoneNumber">Experience(in years)</label>
                        </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-12">
                        ...
                        <select class="select form-control-lg" name="specialization">
