...
<table align=center class="styled-table">
    ...
    <tbody>
<tr><th>ID:</th>&nbsp;<td>${patientlist.id}</td></tr>
<tr><th>Name:</th>&nbsp;<td>${patientlist.name}</td></tr>
<tr><th>Gender:</th>&nbsp;<td>${patientlist.gender}</td></tr>
<tr><th>Email ID:</th>&nbsp;<td>${patientlist.emailid}</td></tr>
<tr><th>User Name:</th>&nbsp;<td>${patientlist.username}</td></tr>
<tr><th>Contact No:</th>&nbsp;<td>${patientlist.contactno}</td></tr>
        <!-- and so on... -->
    </tbody>
</table>
